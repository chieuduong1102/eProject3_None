...
namespace eProject3_Verhicle_Management.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,CustomerId,TotalPrice,DeliveryAddress,CreatedDate,UpdatedDate,StatusOrder")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,CustomerId,TotalPrice,DeliveryAddress,CreatedDate,UpdatedDate,StatusOrder")] Order order)
        {
            if (ModelState.IsValid)
            {
