...
namespace eProject3_Verhicle_Management.Controllers
{
    public class VehicleTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,VehicleType1")] VehicleType vehicleType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,VehicleType1")] VehicleType vehicleType)
        {
            if (ModelState.IsValid)
            {
